...
Route::get('/download/manual/{name}', "WebController@downloadManual")->name("manual");
...
Route::post('/completeMantainment', "ProcessController@completeMantainment")->name("completeMantainment");
